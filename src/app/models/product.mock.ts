    ...
    reviews: [
      {
        ...
        rating: 5,
        comment:
          'Hulkbuster is a beast.....Finally acquired my grail..... Speechless.....Thanks Seller for quick shipping and thanks {name of our website}  for making such cool 1/6th figure.',
      },
      {
        userName: 'Fat Trick Abba Yale Thee',
        rating: 4,
        comment:
          'When it comes to Hulkbuster, there is no comparison. It stands alone. The design, the detail, the sheer weight of this thing is jaw dropping. It is crown jewel of my collection. Thank you seller',
      },
      {
        userName: 'Ear Win Men dose Ugh',
        rating: 5,
        comment:
          'This figure/model goes beyond expectations. I have had this item for 2-3 weeks now and am still marvelling at it. The pieces have great attention to detail.',
      },
